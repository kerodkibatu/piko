...
public class SettingsStatus {
    ...
    public static void hideChat() { hideChat = true; }
    public static boolean dmSection(){ return markChatAsRead || hideChat || unlimitedReplaysOnEphemeralMedia || disableTypingStatus || viewDmAnonymously || saveDeletedMessages ;}
    ...
    public static boolean filterContentSection(){return storyFilters; }
        ...
        FLAGS.put(str("piko_enable_hide_chat"),SettingsStatus.hideChat);
